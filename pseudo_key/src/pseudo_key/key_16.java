...
public class key_16 {
	...
	//erstellt nächsten Teilkey mit 16 Bit
	public int next_key() 
	{
		int x = _x;
	...
	{ 
		/*
		//1, 16
		//Soll: 1000101011010010
		//Ist:  1000101011010010
		key_16 gen2 = new key_16(1);
		long key2=gen2.next_key();
		System.out.print(to_bin(key2));
		return;
		*/
		/*
		//1,32
		//Soll: 10001010110100101111001011110010
		//Ist:  10001010110100101101001001101010
		key_16 gen2 = new key_16(1);
		long key2=gen2.next_key();
		System.out.print(to_bin(key2));
		key2=gen2.next_key();
		...
		return;*/
		/*
		key_16 first_key = new key_16(88);
		for(int i =0;i<4;i++) {
			long key=first_key.next_key();
			System.out.print(to_bin(key));
		}*/
		//88,63
